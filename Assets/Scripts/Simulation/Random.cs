...
{
    public static int rngIndex(uint threadIndex)
    {
        return (int)(threadIndex) % _rngCount;
    }
    ...
    public static int rng(int rngIndex)
    {
        ...
        while( prevPos != exchangedPos )
        {
            ...
            InterlockedCompareExchange( ref _rngState[rngIndex*(_rngStateLength+1)], prevPos, nextPos, out exchangedPos );
            ...
            {
                Debug.Log("exchangedPos != prevPos");
            }
        }
        return result; 
    }
